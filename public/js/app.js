    ...
    if (xhr.readyState == XMLHttpRequest.DONE) {
      $(searchField).on('input', function () {
        ...
        data.forEach(function (array) {
          ...
          if (filter === "note") {
            found = array.note.match(searchTerm);
          } else {
            found = array.name.match(searchTerm);
          }
          ...
          if (found && searchTerm != '/(?:)/') {
            ...
            sideOverlays.appendChild(a); //DRAWING SYMBOLS 
...
jQuery(document).ready(function () {
  ...
  var uploadPdfButton = document.getElementById('uploadPdfButton');
  var searchInput = document.getElementById('searchInput');
  var showUploadForm = document.getElementById('showUploadForm');
  var arrowFunction = document.getElementById('arrow');
  var showContact = document.getElementById('showContactButton');
  var contactFormSend = document.getElementById('contactFormSend');
  ...
  arrowFunction.addEventListener('click', function () {
    ...
    $("#openseadragon").toggleClass("col-md-12 col-md-10");
  });
  ...
  sendFormButton.addEventListener('click', function () {
    return sendForm(sessionStorage.getItem('sym'), sessionStorage.getItem('color'));
  });
  populateMaps();
});
...
contactSend = function contactSend() {
